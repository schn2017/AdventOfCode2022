...
class Monkey:
    ...
    def inspectItems(self):
        for index in range(0, len(self.items)):
            self.items[index] = self.performOperation(self.items[index]) % self.modAmount
...
class MonkeyBusiness:
    ...
    def performRounds(self):
        ...
        for monkey in self.monkeys:
            monkey.modAmount = self.modAmount
...
def main():
    monkeyBusiness = MonkeyBusiness(10000)
